                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="header-top-left">
                                    <ul class="phone-wrap">
                                        <li><span>Teléfono de Consulta:</span><a href="#">(+123) 123 321 345</a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9 col-md-8">
                                <div class="header-top-right">
                                    <ul class="ht-menu">
                                        <!-- Begin Setting Area -->
                                        <li>
                                            <div class="ht-setting-trigger"><span>Configuración</span></div>
                                        ...
                                        <li>
                                            ...
                                            <div class="language ht-language">
                                                <ul class="ht-setting-list">
                                                    <li class="active"><a href="#"><img src="images/menu/flag-icon/1.jpg" alt="">Inglés</a></li>
                                                    <li><a href="#"><img src="images/menu/flag-icon/2.jpg" alt="">Español</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                    ...
                                    <ul class="hm-menu">
                                        ...
                                        <li class="hm-minicart">
                                            <div class="hm-minicart-trigger">
                                                ...
                                                <span class="item-text">BOB. 80.00
                                                ...
                                                <ul class="minicart-product-list">
                                                    <li>
                                                        ...
                                                        <div class="minicart-product-details">
                                                            <h6><a href="single-product.html">Ejemplo de TV</a></h6>
                                                            <span>£40 x 1</span>
                                                        </div>
                                                        <button class="close">
                                       ...
                                       <ul>
                                           <li class="dropdown-holder"><a href="index.html">Inicio</a>
                                               <ul class="hb-dropdown">
                                                   ...
                                                   <li class="active"><a href="index-4.html">Inicio Cuatro</a></li>
                                               </ul>
                                           </li>
                                    ...
                                    <div class="single-slide align-center-left animation-style-01 bg-1">
                                        ...
                                        <div class="slider-content">
                                            ...
                                            <div class="default-btn slide-btn">
                                                <a class="links" href="shop-left-sidebar.html">Compras Ahora</a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="li-product-tab">
                                <ul class="nav li-product-menu">
                                   <li><a class="active" data-toggle="tab" href="#li-new-product"><span>Nueva Llegada</span></a></li>
                                   <li><a data-toggle="tab" href="#li-bestseller-product"><span>Mejor Vendido</span></a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="li-section-title">
                                <h2>
                                    <span>Computadora portátil</span>
                                </h2>
                                <ul class="li-sub-category-list">
                                    <li class="active"><a href="shop-left-sidebar.html">Prime Video</a></li>
                                    <li><a href="shop-left-sidebar.html">Ordenadores</a></li>
                                    <li><a href="shop-left-sidebar.html">Electrónica</a></li>
                                </ul>
                            </div>
                            <div class="row">
                                            ...
                                            <div class="product_desc">
                                                ...
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                                        <li class="add-cart active"><a href="#">Añadir Al Carrito</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="li-static-home-content">
                                <p>Oferta de venta<span>-20% de descuento</span>esta semana</p>
                                <h2>Producto destacado</h2>
                                <h2>Accesorios Sanai 2022</h2>
                                <p class="schedule">
                                    Desde
                                    <span> $1209.00</span>
                                </p>
                                <div class="default-btn">
                                    <a href="shop-left-sidebar.html" class="links">Compras Ahora</a>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                                    <div class="li-shipping-inner-box">
                                        ...
                                        <div class="shipping-text">
                                            ...
                                            <p>Y devoluciones gratis. Consulte la caja para conocer las fechas de entrega.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                                    <div class="li-shipping-inner-box">
                                        ...
                                        <div class="shipping-text">
                                            ...
                                            <p>¿Tengo una pregunta? Llame a un especialista o chatee en línea.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Li's Shipping Inner Box Area End Here -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="footer-logo">
                                        ...
                                        <p class="info">
                                            Somos un equipo de diseñadores y desarrolladores que crean plantillas HTML de alta calidad y Woocommerce, Shopify Theme.
                                        </p>
                                    </div>
                                    <ul class="des">
                                        <li>
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-6">
                                    <div class="footer-block">
                                        <h3 class="footer-block-title">Producto</h3>
                                        <ul>
                                            <li><a href="#">Bajan los precios</a></li>
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-6">
                                    <div class="footer-block">
                                        <h3 class="footer-block-title">Nuestra compañia</h3>
                                        <ul>
                                ...
                                <div class="col-lg-4">
                                    <div class="footer-block">
                                        <h3 class="footer-block-title">Síganos</h3>
                                        ...
                                        <form action="#" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="footer-subscribe-form validate" target="_blank" novalidate>
                                           <div id="mc_embed_signup_scroll">
                                              <div id="mc-form" class="mc-form subscribe-form form-group" >
                                                <input id="mc-email" type="email" autocomplete="off" placeholder="Introduce tu correo electronico" />
                                                <button  class="btn" id="mc-submit">Suscribir</button>
                                              </div>
                                           </div>
                                        </form>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="footer-links">
                                    <ul>
                                        <li><a href="#">Las compras en línea</a></li>
                                        <li><a href="#">Promociones</a></li>
                                        <li><a href="#">Mis ordenes</a></li>
                                        <li><a href="#">Ayuda</a></li>
                                        <li><a href="#">Servicio al Cliente</a></li>
                                        <li><a href="#">Apoyo</a></li>
                                        <li><a href="#">Most Populares</a></li>
                                ...
                                <div class="copyright text-center pt-25">
                                    <span><a target="_blank" href="https://www.templateshub.net">Centro de plantillas</a></span>
                                </div>
